...
const menuLinks = document.querySelectorAll('.smooth-scrolling[data-goto]');
...
if (animItems.length > 0) {
  ...
  function animOnScroll(params) {
    for (let index = 0; index < animItems.length; index++) {
      ...
      let animItemPoint = window.innerHeight - animItemHeight / 6;
			if (animItemHeight > window.innerHeight) {
				animItemPoint = window.innerHeight - window.innerHeight / 6;
			}
...
//! Валидация INPUT (заполнен ли инпут)==================================================================================

function form_validate(form) {
	let error = 0;
	let form_req = form.querySelectorAll('[data-required]');
...
//! Валидация EMAIL (написана ли почта?)==================================================================================
...
//! Валидация ERROR (если инпут не заполнен)==================================================================================
